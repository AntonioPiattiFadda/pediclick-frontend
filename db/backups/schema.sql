...
COMMENT ON TYPE "public"."stock_type" IS 'ELIMINAR';
...
COMMENT ON TABLE "public"."lots" IS 'Lots has initial data and costs and belonging to product or product presentations in case of FRACTIONS';



COMMENT ON COLUMN "public"."lots"."product_presentation_id" IS 'In case of FRACTIONS';
...
COMMENT ON TABLE "public"."stock" IS 'Stcok represents the quantity and location of mercancy';
...
ALTER TABLE ONLY "public"."lots"
    ADD CONSTRAINT "lots_product_presentation_id_fkey" FOREIGN KEY ("product_presentation_id") REFERENCES "public"."product_presentations"("product_presentation_id");
