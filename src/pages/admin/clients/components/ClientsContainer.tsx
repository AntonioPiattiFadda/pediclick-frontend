...
import { ClientSelectorRoot, CreateClient } from "@/components/admin/selectors/clientSelector";
import { CreateProvider, ProviderSelectorRoot } from "@/components/admin/selectors/providersSelector";
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <ProvidersTable providers={providers} filter={''} />
                </CardContent>
            </Card>
        </div>
    );
