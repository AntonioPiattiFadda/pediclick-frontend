...
interface LoadOrderTableProps {
  ...
  expandedLots: Record<number, boolean>;
  toggleExpanded: (lotId?: number) => void;
  loadOrderId: number;
}

export const TransferOrderTable = ({ loadOrderData, expandedLots, toggleExpanded, loadOrderId }: LoadOrderTableProps) => {
